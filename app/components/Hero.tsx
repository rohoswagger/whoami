  ...
  return (
    <div className="min-h-screen flex flex-col justify-center px-4 md:px-8 lg:px-16">
      <div className="max-w-4xl space-y-12">
        {/* Main heading */}
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold text-gray-900 leading-tight">
          yo! i&apos;m roshan
        </h1>
        
        {/* Subtitle */}
        <p className="text-3xl md:text-4xl lg:text-5xl text-gray-600 leading-relaxed">
          i build things
        </p>
